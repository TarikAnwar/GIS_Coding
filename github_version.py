...
Each shapefile had to have the same name as the .tiff files. 
...
def create_shapefile(image_dir_path,shapefile_template):#creating empty shapefiles from template
...
##!!!make sure to remove the created shapefiles in the table of contents before proceeding in order for the other function to work!!!!

##Functions have to be run seperately!!!
